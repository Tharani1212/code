  ...
  org.springframework.security.oauth2.provider.approval.ApprovalStore; import
  ...
  TokenStoreUserApprovalHandler; import
  org.springframework.security.oauth2.provider.request.
  DefaultOAuth2RequestFactory; import
  ...
  @EnableWebSecurity public class OAuth2SecurityConfiguration extends
  ...
  @Autowired public TokenStoreUserApprovalHandler
  userApprovalHandler(TokenStore tokenStore){ TokenStoreUserApprovalHandler
